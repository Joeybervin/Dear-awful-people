...
#fincombat = pygame.image.load('assets/button_fincombat.png')

#AJOUT CODE JOEY
# Le boutton si le joueur ne souhaite plus rajouter de mot ou bien à finis sa phrase
...
# images pour le combat (bulle d'affichaqe, fanion de signalement de tour)
...
# lettre d'affichage des "gros mots"
...
list_mots = [Mot("pauvre","adjectif","argent"), Mot("binoclard","adjectif","yeux"), Mot("laide","adjectif","épouse"),
             ...
             #Nom
             Mot("votre strabisme","nom","yeux"), Mot("un dentier","nom","dent"), Mot("des caries","nom","dent"),
             Mot("votre misérable mère","nom","mère"), Mot("personne","nom","célibataire"), Mot("d'une paire de lunettes","nom","yeux"),
             Mot("la fête","nom","neutre"), Mot("hygiène","nom","odeur"), Mot("votre conjointe","nom","épouse"),
             Mot("votre bouche","nom", "dent"), Mot("une peripatéticienne","nom","épouse"), Mot("dentifrice","nom", "odeur"),
             Mot("cocu", "nom", "épouse"), Mot("la jeune femme","nom","épouse"), Mot("votre face","nom","argent"),
             Mot("mon pauvre", "adjectif", "argent"),
             #Expression
             Mot("telle mère telle fille","expression","mère"), Mot("on sait tous que","expression","neutre"),
             Mot("L'argent ne fait pas le bonheur","expression","argent"), Mot("le jour de votre enterrement", "expression","age"),
             ...
             Mot("il y a 20 ans", "autre", "age"), Mot("besoin de", "autre", "neutre"), Mot("il ne faut pas s'étonner si", "autre", "neutre"),
...
list_mots_soutenu = [Mot("cuistre","adjectif","intelligence"), Mot("philistin","adjectif","intelligence"),
                     ...
                     #Expression
                     Mot("Je vous conchie","expression","intelligence"),Mot("on sait tous que","expression","neutre"),
                     #Verbe
                     Mot("lanterner", "verbe", "célibataire"), Mot("veuillez", "verbe", "neutre"),
                     Mot("Vous avez besoin", "verbe", "neutre"),
                     Mot("Laisser moi rire de", "verbe", "neutre")]
